...
def render_rotational_tab(df_exp=None):
    ...
    st.markdown("""
    Rotational number **N_rot = τ_trans / τ_rot** measures how many rotations
    a polymer completes while its center of mass diffuses a distance R.

    - **N_rot > 1**: Polymer rotates faster than it translates (rotation-dominated)
    - **N_rot < 1**: Polymer translates faster than it rotates (translation-dominated)
